    ...
    return(
        <div className="service">
            <div className="left">
                ...
                <div className="des">
                    <h4>รับจ้างออกแบบพัฒนาโปรแกรมเว็บไซต์ และ แอพพลิเคชั่น</h4>
                    <span style={{display:"block",width:"100%",wordWrap:"break-word"}}>
                        บริการรับจ้างออกแบบพัฒนาโปรแกรมโดยเริ่มจากสอบถามข้อมูลความต้องการเริ่มต้นจากผู้จ้างและทำการประเมินราคา
